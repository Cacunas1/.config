...
wk.add({
  {
    ...
    { "<leader>ss", ":w<cr>", desc = "[s]ave buffer/file" },
    { "<leader>v", group = "[v]im" },
    ...
    { "<leader>vq", ":qa<cr>", desc = "[q]uit" },
    { "<leader>w", group = "[w]indow" },
    { "<leader>w/", "<C-w>v", desc = "[W]indow split vertical" },
    { "<leader>w-", "<C-w>s", desc = "[W]indow split horizontal" },
    { "<leader>w=", "<C-w>=", desc = "[W]indow make split equal (=) size" },
    { "<leader>wh", "<C-w>h", desc = "Move to left [W]indow" },
    { "<leader>wl", "<C-w>l", desc = "Move to right [W]indow" },
    { "<leader>wj", "<C-w>j", desc = "Move to upper [W]indow" },
    { "<leader>wk", "<C-w>k", desc = "Move to lower [W]indow" },
    { "<leader>wd", "<cmd>close<CR>", desc = "[W]indow [D]elete" },
    { "<leader>t", group = "[t]tab" },
    { "<leader>to", "<cmd>tabnew<CR>", desc = "[T]ab [O]pen" },
    { "<leader>td", "<cmd>tabclose<CR>", desc = "[T]ab [D]elete" },
    { "<leader>tn", "<cmd>tabn<CR>", desc = "[T]ab [N]ext" },
    { "<leader>tp", "<cmd>tabp<CR>", desc = "[T]ab [P]previous" },
    { "<leader>tf", "<cmd>tabnew %<CR>", desc = "[T]ab open bu[F]fer in new tab (?)" },
    ...
    { "<leader>bb", "<cmd>buffers<CR>", desc = "[B]uffer of [B]uffers" },
  },
}, { mode = "n" })
